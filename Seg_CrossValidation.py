    ...
    for i in range(nfold):
        ...
        with open(train_path, 'w',encoding='utf-8') as f:
            for d in range(len(train)):
                ...
                f.write('train'+str(id)+'\t'+str(sentence) + '\t'+str(label2id)+'\n')
...
if __name__ == "__main__":
    readExcel('D:\PycharmProjects\cross_val data\小样本训练语料.xlsx', 'Sheet1')
    buildDataSet('other')
    write_dataset_to_file('seg_cross_validation', 5)
