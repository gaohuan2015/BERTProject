...
trainDataFile = 'integration_model\generation\\traindata_vec.txt'
testDataFile = 'integration_model\generation\\testdata_vec.txt'


def get_testdata(file=testDataFile):
    testData = open(testDataFile, 'r',encoding='UTF-8').read().split('\n')
...
class textCNN_data(Dataset):
    def __init__(self):
        trainData = open(trainDataFile, 'r',encoding='UTF-8').read().split('\n')
