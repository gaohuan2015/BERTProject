...
# This file can be used to generate the dataset, mainly used to model deliver
# --------------------------------****************************-----------------------------------------------------
...
def buildDataSet(mode):
    id = 0
    f = open('./data/Small/label2id.json', 'r', encoding='utf-8')
...
if __name__ == "__main__":
    readExcel('./test.xlsx', 'Sheet1')
    buildDataSet('other')
    write_dataset_to_file('./data/Small/')
