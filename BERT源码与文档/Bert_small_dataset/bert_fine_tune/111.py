...
parser.add_argument("--n_gpu", default=1, type=int, help="验证时batch大小")
...
parser.add_argument("--per_gpu_eval_batch_size", default=184, type=int, help="验证时batch大小")
...
parser.add_argument("--num_train_epochs", default=65, type=float, help="训练的epochs次数")
parser.add_argument(
