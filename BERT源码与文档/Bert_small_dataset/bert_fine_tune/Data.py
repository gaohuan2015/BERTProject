...
# This file is used to data processing
# --------------------------------****************************-----------------------------------------------------
...
# definite the example of the model input
...
# definite the features of the model input
...
# the data processor belong to the this task
class DataProcessor(object):
    ...
    @classmethod
    # the specific file reader of our task
    def read_csv(cls, input_file):
        """
        :param input_file: input file path
        :return: return the list of every tuple that own the type of (segid, sentence, lab)
        """
        li_exam = []
